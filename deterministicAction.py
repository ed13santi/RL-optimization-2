...
def main():
    ...
    storage_path = "/rds/general/user/eds17/home/RL-optimization-2/optRLFilesDet/"
    ...
    for episode in range(n_episodes):
        ...
        for it in range(episode_length):
            ...
            noisy_actions = np.clip(np.random.normal(loc=local_actions, scale = a_std), 0, 1)
            ...
            rs.append(r)
            u = [loc_obj(x_i) for x_i, loc_obj in zip(xs, local_objs)]
            us.append(u)
