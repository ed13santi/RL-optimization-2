...
for episode in range(n_episodes):
    ...
    filehandler =  open('$HOME/replay_mem', 'wb') 
    pickle.dump(replay_mem, filehandler)
    filehandler =  open('$HOME/Rs', 'wb')
    pickle.dump(Rs, filehandler)
    for i in range(N):
        actors[i].NN.save("$HOME/actor_{}".format(i))
        actors[i].target_NN.save("$HOME/actorTrgt_{}".format(i))
        critics[i].NN.save("$HOME/critics_{}".format(i))
        critics[i].target_NN.save("$HOME/criticsTrgt_{}".format(i))
